...
public:
	...
	void Shutdown();
	void Render(ID3D11DeviceContext*, ShaderManager*, const XMMATRIX&, const XMMATRIX&, const XMMATRIX&, ID3D11ShaderResourceView*);
...
private:
	...
	void RenderSentence(ID3D11DeviceContext*, ShaderManager*, const XMMATRIX&, const XMMATRIX&, const XMMATRIX&, ID3D11ShaderResourceView*);
