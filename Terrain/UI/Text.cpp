...
void Text::Render(ID3D11DeviceContext* deviceContext, ShaderManager* ShaderManager, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, 
...
void Text::RenderSentence(ID3D11DeviceContext* deviceContext, ShaderManager* ShaderManager, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix,
							   const XMMATRIX& orthoMatrix, ID3D11ShaderResourceView* fontTexture)
{
