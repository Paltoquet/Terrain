...
LandShader::LandShader(const LandShader& other)
{
...
bool LandShader::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;


	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, L"ShaderSource/terrain.vs", L"ShaderSource/terrain.ps");
	if (!result)
	{
		return false;
	}
...
bool LandShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
...
void LandShader::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
...
void LandShader::ShutdownShader()
{
